...
public class Data {
	...
	public Data(String root, String symbol, String interval) {
		this.symbol = symbol;
		this.interval = interval;
		this.download = false;
	...
	public void donwload(long time, String[] header, long pause) {
		this.pause = pause;
		startSave(it, symbol, interval, time, header);
	}

	public void donwload(long time, long pause) {
		this.pause = pause;
		startSave(it, symbol, interval, time, null);
	}
	
	public void donwload(long time, String[] header, long pause, boolean print) {
		this.pause = pause;
		this.download = true;
	...
	public void donwload(long time, long pause, boolean print) {
		this.pause = pause;
